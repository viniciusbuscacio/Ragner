...
class IndexarDocumentosUseCase:
    ...
    def indexar_documento(self, caminho_arquivo):
        ...
        try:
            ...
            # 5.2) Extrair o conteúdo de texto do arquivo usando o loader apropriado
            # O loader já sabe como extrair o texto apropriadamente para cada tipo de arquivo
            conteudo_texto = ""
            if tipo == "txt":
                ...
                conteudo_texto = "\n\n".join(chunks_texto)  # Juntamos os chunks com quebras de linha
            ...
            for i, texto_chunk in enumerate(chunks_texto):
                # Criar um objeto Chunk com os novos campos
                chunk = Chunk(
